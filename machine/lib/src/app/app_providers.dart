...
import 'package:machine/src/data/repositories/active_courses/active_courses_http_repository.dart';
...
import 'package:machine/src/data/services/active_courses_clients/active_courses_http_client.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create:
              (context) => ActiveCoursesController(
                repository: ActiveCoursesHttpRepository(
                  client: ActiveCoursesHttpClient(),
                  baseUrl: AppShared.coursesUrl,
                ),
              ),
        ),
      ],
